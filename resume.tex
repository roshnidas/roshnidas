...
\begin{document}
    ...
    \section{Professional Summary}
        ...
        \begin{onecolentry}
            I have extensive experience in system design, crafting solutions that support complex workflows, integrate with diverse systems, and scale to accommodate large user bases and high transaction volumes. My expertise spans Full-Stack Development, Backend Development, and DevOps, where I have designed and implemented fault-tolerant services, streamlined operations, and reduced technical debt in fast-paced, collaborative environments.
        \end{onecolentry}
